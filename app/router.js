...
router.post('/machine',authMiddleware,uploadMiddleware,geocodingZipCode,mainController.submitAction); // Add a new machine
...
router.post('/signup',uploadMiddleware,authController.signupAction); // Signup route
